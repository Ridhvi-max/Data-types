...
background_image = pygame.transform.scale(pygame.image.load("C:\\Users\\DELL\\OneDrive\\Desktop\\Phython course\\lesson34\\bg.jpg"),
...
sprite1.rect.x, sprite1.rect.y = random.randint(
    0, SCREEN_WIDTH - sprite1.rect.width), random.radint(
